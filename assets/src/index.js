  ...
  return `
      	<li class="product-item">
		    <a href="">
               ...
               src="${products.imgSrc}" alt="${products.title}" width="345px">
		    	  <div class="card-meta">
		    	   	<p class="card-info">${products.title}</p>
                ${products.availability === "Skladem" ? `<p class="card-text green">${products.availability}</p>` : ''}
                ${products.availability === "Momentálně nedostupné" ? `<p class="card-text red">${products.availability}</p>` : ''}
                ${products.availability === "Na objednávku" ? `<p class="card-text grey">${products.availability}</p>` : ''} 
		    	   	<p class="card-price">${products.price} CZK</p>
		    	  </div>
              <div class="flags-thumb"> 
                ${products.flags[0] ? `<p class="flag-first"> ${products.flags[0]}</p>` : ''}                                               
                ${products.flags[1] ? `<p class="flag-second"> ${products.flags[1]}</p>` : ''}  
              </div>
